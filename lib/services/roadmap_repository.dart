...
class RoadmapRepository {
  ...
  final Map<String, RewardDefinition> _rewards = {
    ...
    'rew_fractions_q1_xp': RewardDefinition(
      id: 'rew_fractions_q1_xp',
      type: RewardType.xp,
      name: 'Quest 1 Mastery XP',
      amount: 75,
      rarity: RewardRarity.common,
    ),
    'rew_fractions_q1_coins': RewardDefinition(
      id: 'rew_fractions_q1_coins',
      type: RewardType.coins,
      name: 'Quest 1 Quest Coins',
      amount: 10,
      rarity: RewardRarity.common,
    ),
    'rew_fractions_q2_xp': RewardDefinition(
      id: 'rew_fractions_q2_xp',
      type: RewardType.xp,
      name: 'Proportions Mastery XP',
      amount: 100,
      rarity: RewardRarity.common,
    ),
    'rew_fractions_q2_coins': RewardDefinition(
      id: 'rew_fractions_q2_coins',
      type: RewardType.coins,
      name: 'Proportions Gold Sack',
      amount: 20,
      rarity: RewardRarity.common,
    ),
    ...
    'rew_fractions_n2_xp': RewardDefinition(
      id: 'rew_fractions_n2_xp',
      type: RewardType.xp,
      name: 'Ratios Mastery XP',
      amount: 75,
      rarity: RewardRarity.common,
    ),
    'rew_fractions_n2_coins': RewardDefinition(
      id: 'rew_fractions_n2_coins',
      type: RewardType.coins,
      name: 'Ratios Gold Sack',
      amount: 10,
      rarity: RewardRarity.common,
    ),
    ...
    'rew_fractions_n4_xp': RewardDefinition(
      id: 'rew_fractions_n4_xp',
      type: RewardType.xp,
      name: 'Percentages Mastery XP',
      amount: 75,
      rarity: RewardRarity.common,
    ),
    'rew_fractions_n4_coins': RewardDefinition(
      id: 'rew_fractions_n4_coins',
      type: RewardType.coins,
      name: 'Percentages Gold Sack',
      amount: 10,
      rarity: RewardRarity.common,
    ),
    ...
    if (moduleId == 'mod_fractions') {
      return [
        RoadmapNode(
          ...
          title: '🌱 Quest 1 – Fractions',
          description: 'Master the fundamental concepts of fractions across all 5 lessons.',
          order: 1,
          prerequisiteNodeIds: [],
        ...
        RoadmapNode(
          ...
          title: '🎁 Claim Reward',
          description: 'Claim your earned 75 XP and 10 Quest Coins from Quest 1 to unlock Quest 2 – Ratios.',
          order: 2,
          prerequisiteNodeIds: ['fractions_node1'],
          rewardIds: ['rew_fractions_q1_xp', 'rew_fractions_q1_coins'],
          isOptional: false,
        ),
        RoadmapNode(
          id: 'fractions_node3',
          moduleId: 'mod_fractions',
          type: RoadmapNodeType.level,
          title: '⚖️ Quest 2 – Ratios',
          description: 'Learn ratios, mixtures, and notation in the Alchemist workshop.',
          order: 3,
          prerequisiteNodeIds: ['fractions_node2'],
          rewardIds: ['rew_fractions_n2_xp', 'rew_fractions_n2_coins'],
          levelId: 'ratios_lvl1',
          lessonId: 'ratios_les1',
          isOptional: false,
        ),
        RoadmapNode(
          id: 'fractions_node4',
          moduleId: 'mod_fractions',
          type: RoadmapNodeType.level,
          title: '📐 Quest 3 – Proportions',
          description: 'Scale objects, calculate cross-multiplication, and balance ratios in the Scale Castle.',
          order: 4,
          prerequisiteNodeIds: ['fractions_node3'],
          rewardIds: ['rew_fractions_n3_xp', 'rew_fractions_n3_coins'],
          levelId: 'proportions_lvl1',
          lessonId: 'proportions_les1',
          isOptional: false,
        ),
        RoadmapNode(
          id: 'fractions_node5',
          ...
          type: RoadmapNodeType.milestone,
          title: '🏆 Claim Reward',
          description: 'Claim your earned 100 XP and 20 Quest Coins from Quest 3 to unlock Quest 4 – Percentages.',
          order: 5,
          prerequisiteNodeIds: ['fractions_node4'],
          rewardIds: ['rew_fractions_q2_xp', 'rew_fractions_q2_coins'],
          isOptional: false,
        ),
        RoadmapNode(
          id: 'fractions_node6',
          moduleId: 'mod_fractions',
          type: RoadmapNodeType.level,
          title: '🏷️ Quest 4 – Percentages',
          description: 'Master 100-grids, discounts, and decimal conversions at the Market Bazaar.',
          order: 6,
          prerequisiteNodeIds: ['fractions_node5'],
          rewardIds: ['rew_fractions_n4_xp', 'rew_fractions_n4_coins'],
          levelId: 'percentages_lvl1',
          lessonId: 'percentages_les1',
          isOptional: false,
        ),
        RoadmapNode(
          id: 'fractions_node7',
          moduleId: 'mod_fractions',
          type: RoadmapNodeType.level,
          title: '🏰 Quest 5 – Real-World Applications',
          description: 'Synthesize all mathematics skills to engineer bridges and blueprints for the Kingdom.',
          order: 7,
          prerequisiteNodeIds: ['fractions_node6'],
          rewardIds: ['rew_fractions_n5_xp', 'rew_fractions_n5_coins'],
          levelId: 'applications_lvl1',
          lessonId: 'applications_les1',
          isOptional: false,
        ),
        RoadmapNode(
          id: 'fractions_node8',
          ...
          title: '🏆 Mathematics Grand Master',
          description: 'Conquer all 5 Quests and claim the legendary Grand Master Trophy and Golden Chest!',
          order: 8,
          prerequisiteNodeIds: ['fractions_node7'],
