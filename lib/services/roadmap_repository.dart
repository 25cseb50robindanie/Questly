    ...
    if (moduleId == 'mod_fractions') {
      return [
        RoadmapNode(
          ...
          description: 'Master the fundamental concepts of fractions across all 5 levels.',
          order: 1,
          prerequisiteNodeIds: [],
        ...
        RoadmapNode(
          ...
          description: 'A mystery gift box unlocked after conquering fraction basics.',
          order: 2,
        ...
        RoadmapNode(
          ...
          description: 'Learn ratios, mixtures, and proportions in the Alchemist workshop.',
          order: 3,
          prerequisiteNodeIds: ['fractions_node1'],
          rewardIds: ['rew_fractions_n3_xp', 'rew_fractions_n3_coins'],
          levelId: 'fractions_lvl2',
        ...
        RoadmapNode(
          ...
          title: '🦊 Dendy\'s Ratio Challenge',
          description: 'Mix ratio potions with Dendy to unlock bonus gold and XP.',
          order: 4,
          prerequisiteNodeIds: ['fractions_node3'],
          rewardIds: ['rew_fractions_side_xp', 'rew_fractions_side_coins'],
          isOptional: true,
        ),
        RoadmapNode(
          id: 'fractions_node5',
        ...
        RoadmapNode(
          ...
          title: '🏆 Fractions & Ratios Mastery',
          description: 'Master fractions & ratios canyon crossings and unlock the legendary master chest.',
          order: 7,
